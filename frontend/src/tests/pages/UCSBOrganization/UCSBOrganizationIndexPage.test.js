...
describe("UCSBOrganizationIndexPage tests", () => {
    ...
    test("renders three ucsborganization correctly for regular user", async () => {
        ...
        await waitFor(() => { expect(screen.getByTestId(`${testId}-cell-row-0-col-orgCode`)).toHaveTextContent("OSLI"); });
        ...
        const orgCode = screen.getByText("OSLI");
    ...
    test("what happens when you click delete, admin", async () => {
        ...
        axiosMock.onGet("/api/ucsborganization/all").reply(200, ucsbOrganizationFixtures.threeOrganizations);
        axiosMock.onDelete("/api/ucsborganization").reply(200, "UCSBOrganization with orgCode OSLI was deleted"); //FIX
        ...
        await waitFor(() => { expect(mockToast).toBeCalledWith("UCSBOrganization with orgCode OSLI was deleted") });
