...
describe("RecommendationRequestEditPage tests", () => {
    ...
    describe("tests where backend is working normally", () => {
        ...
        test("Changes when you click Update", async () => {
            ...
            fireEvent.change(explanationField, { target: { value: "PhD CS Stanford" } })
            fireEvent.change(dateRequestedField, { target: { value: '2022-05-20T00:00' } })
            fireEvent.change(dateNeededField, { target: { value: '2022-11-15T00:00' } })
