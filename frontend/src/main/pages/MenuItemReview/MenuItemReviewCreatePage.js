...
export default function MenuItemReviewCreatePage({storybook=false}) {
  ...
  const onSuccess = (review) => {
    toast(`New MenuItemReview Created - id: ${review.id} itemId: ${review.itemId} reviewerEmail: ${review.reviewerEmail} stars: ${review.stars} dateReviewed: ${review.dateReviewed} comments: ${review.comments}`);
  }
