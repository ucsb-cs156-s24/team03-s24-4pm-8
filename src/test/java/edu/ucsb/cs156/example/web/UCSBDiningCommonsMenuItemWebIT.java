...
public class UCSBDiningCommonsMenuItemWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_ucsbDiningCommonsMenuItem() throws Exception {
        ...
        page.getByTestId("UCSBDiningCommonsMenuItemForm-diningCommonsCode").fill("ortega"); // might have to change to ITEMS
        ...
        assertThat(page.getByTestId("UCSBDiningCommonsMenuItemTable-cell-row-0-col-station")).hasText("Salad Bar");
