...
public class RecommendationRequestWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_recommendation_request() throws Exception {
        ...
        page.getByTestId("RecommendationRequestForm-professorEmail").fill("ldelplaya@ucsb.edu");
        page.getByTestId("RecommendationRequestForm-submit").click();

        assertThat(page.getByTestId("RecommendationRequestTable-cell-row-0-col-professorEmail")).hasText("ldelplaya@ucsb.edu");
