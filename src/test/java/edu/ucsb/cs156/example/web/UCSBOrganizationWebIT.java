...
public class UCSBOrganizationWebIT extends WebTestCase {
    ...
    public void admin_user_can_create_edit_delete_organization() throws Exception {
        ...
        page.getByTestId("UCSBOrganizationForm-orgCode").fill("ABC");
        page.getByTestId("UCSBOrganizationForm-orgTranslationShort").fill("ALPHA BETA C");
        page.getByTestId("UCSBOrganizationForm-orgTranslation").fill("ALPHA BETA CLUB");
        ...
        page.getByTestId("UCSBOrganizationForm-orgTranslation").fill("ALPHA BETA CLUBS");
        page.getByTestId("UCSBOrganizationForm-submit").click();

        assertThat(page.getByTestId("UCSBOrganizationTable-cell-row-0-col-orgTranslation")).hasText("ALPHA BETA CLUBS");
